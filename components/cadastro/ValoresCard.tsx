    ...
    <div className="-translate-y-7 max-w-3xl mx-auto px-5">
      <div className="bg-white rounded-xl shadow-md border-t-[3px] border-honey px-8 py-7">
        <div className="grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-cream-alt">
          {VALORES.map((v) => (
            <div key={v.label} className="px-6 py-4 sm:py-0 text-center first:pl-0 last:pr-0">
        ...
        <p className="mt-4 pt-4 border-t border-cream-alt text-[0.78rem] text-ink-muted text-center leading-[1.6]">
          <strong className="text-honey-DEFAULT font-medium">Atenção:</strong> Os valores vigentes
          se aplicam a todos os atendimentos, incluindo anamnese, avaliação e sessões terapêuticas.
          Para deslocamento a sítio ou outra cidade, entre em contato para combinar o valor
          adicional.
        </p>
      </div>
    </div>
